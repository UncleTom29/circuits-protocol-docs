...
It provides secondary market liquidity for graduated agent tokens, enabling continuous price discovery, token swaps, and permanent liquidity locks.
...
2. **100% Permanent LP Burn**: All minted LP tokens are sent directly to `0x000000000000000000000000000000000000dEaD` during the `addLiquidity` call, permanently burning LP ownership and eliminating any risk of liquidity withdrawal.
